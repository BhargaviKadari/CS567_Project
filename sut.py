...
class sut(object):
    def act0(self):
        ...
        import TSTL
        '''
        self.__test.append(('''import TSTL ''',self.guard0,self.act0))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''import TSTL '''))
    ...
    def act1(self):
        '''
        class CalculatorHarness(TSTL.TestHarness):
        '''
        self.__test.append(('''class CalculatorHarness(TSTL.TestHarness): ''',self.guard1,self.act1))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''class CalculatorHarness(TSTL.TestHarness): '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act2(self):
        ...
        def __init__(self):
        '''
        self.__test.append(('''def __init__(self): ''',self.guard2,self.act2))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def act3(self):
        ...
        super().__init__()
        '''
        self.__test.append(('''super().__init__() ''',self.guard3,self.act3))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''super().__init__() '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act4(self):
        ...
        def setup(self):
        '''
        self.__test.append(('''def setup(self): ''',self.guard4,self.act4))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def act5(self):
        ...
        '''
        self.__test.append(('''from calculator_module import Calculator ''',self.guard5,self.act5))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''from calculator_module import Calculator '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act6(self):
        ...
        '''
        self.__test.append(('''self.calculator = Calculator() ''',self.guard6,self.act6))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''self.calculator = Calculator() '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act7(self):
        ...
        def teardown(self):
        '''
        self.__test.append(('''def teardown(self): ''',self.guard7,self.act7))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''def teardown(self): '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act8(self):
        ...
        pass
        '''
        self.__test.append(('''pass ''',self.guard8,self.act8))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''pass '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act9(self):
        ...
        @TSTL.property
        '''
        self.__test.append(('''@TSTL.property ''',self.guard9,self.act9))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''@TSTL.property '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act10(self):
        '''
        def test_addition(self, x=TSTL.Int(), y=TSTL.Int()):
        '''
        self.__test.append(('''def test_addition(self, x=TSTL.Int(), y=TSTL.Int()): ''',self.guard10,self.act10))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''def test_addition(self, x=TSTL.Int(), y=TSTL.Int()): '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act11(self):
        ...
        '''
        self.__test.append(('''result = self.calculator.add(x, y) ''',self.guard11,self.act11))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''result = self.calculator.add(x, y) '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act12(self):
        ...
        return result == x + y
        '''
        self.__test.append(('''return result == x + y ''',self.guard12,self.act12))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''return result == x + y '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act13(self):
        ...
        @TSTL.property
        '''
        self.__test.append(('''@TSTL.property ''',self.guard13,self.act13))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def act14(self):
        '''
        def test_subtraction(self, x=TSTL.Int(), y=TSTL.Int()):
        '''
        self.__test.append(('''def test_subtraction(self, x=TSTL.Int(), y=TSTL.Int()): ''',self.guard14,self.act14))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''def test_subtraction(self, x=TSTL.Int(), y=TSTL.Int()): '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act15(self):
        ...
        '''
        self.__test.append(('''result = self.calculator.subtract(x, y) ''',self.guard15,self.act15))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''result = self.calculator.subtract(x, y) '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act16(self):
        ...
        return result == x - y
        '''
        self.__test.append(('''return result == x - y ''',self.guard16,self.act16))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def act17(self):
        ...
        '''
        self.__test.append(('''if __name__ == "__main__": ''',self.guard17,self.act17))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def act18(self):
        '''
        CalculatorHarness().run()
        '''
        self.__test.append(('''CalculatorHarness().run() ''',self.guard18,self.act18))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''CalculatorHarness().run() '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    # END INITIALIZATION CODE
        ...
        self.__actionClasses.append('''import TSTL ''')
        self.__actionClasses.append('''class CalculatorHarness(TSTL.TestHarness): ''')
        self.__actionClasses.append('''    def __init__(self): ''')
        self.__actionClasses.append('''        super().__init__() ''')
        self.__actionClasses.append('''    def setup(self): ''')
        self.__actionClasses.append('''        from calculator_module import Calculator ''')
        self.__actionClasses.append('''        self.calculator = Calculator() ''')
        self.__actionClasses.append('''    def teardown(self): ''')
        self.__actionClasses.append('''        pass ''')
        self.__actionClasses.append('''    @TSTL.property ''')
        self.__actionClasses.append('''    def test_addition(self, x=TSTL.Int(), y=TSTL.Int()): ''')
        self.__actionClasses.append('''        result = self.calculator.add(x, y) ''')
        self.__actionClasses.append('''        return result == x + y ''')
        self.__actionClasses.append('''    @TSTL.property ''')
        self.__actionClasses.append('''    def test_subtraction(self, x=TSTL.Int(), y=TSTL.Int()): ''')
        self.__actionClasses.append('''        result = self.calculator.subtract(x, y) ''')
        self.__actionClasses.append('''        return result == x - y ''')
        self.__actionClasses.append('''if __name__ == "__main__": ''')
        self.__actionClasses.append('''    CalculatorHarness().run() ''')
        self.__dependencies = {}
        self.__dependencies['''import TSTL '''] = []
        self.__dependencies['''class CalculatorHarness(TSTL.TestHarness): '''] = []
        self.__dependencies['''    def __init__(self): '''] = []
        self.__dependencies['''        super().__init__() '''] = []
        self.__dependencies['''    def setup(self): '''] = []
        self.__dependencies['''        from calculator_module import Calculator '''] = []
        self.__dependencies['''        self.calculator = Calculator() '''] = []
        self.__dependencies['''    def teardown(self): '''] = []
        self.__dependencies['''        pass '''] = []
        self.__dependencies['''    @TSTL.property '''] = []
        self.__dependencies['''    def test_addition(self, x=TSTL.Int(), y=TSTL.Int()): '''] = []
        self.__dependencies['''        result = self.calculator.add(x, y) '''] = []
        self.__dependencies['''        return result == x + y '''] = []
        self.__dependencies['''    @TSTL.property '''] = []
        self.__dependencies['''    def test_subtraction(self, x=TSTL.Int(), y=TSTL.Int()): '''] = []
        self.__dependencies['''        result = self.calculator.subtract(x, y) '''] = []
        self.__dependencies['''        return result == x - y '''] = []
        self.__dependencies['''if __name__ == "__main__": '''] = []
        self.__dependencies['''    CalculatorHarness().run() '''] = []
        self.__orderings = {}
        self.__okExcepts = {}
        self.__preCode = {}
        self.__refCode = {}
        ...
        self.__actions.append(('''import TSTL ''',self.guard0,self.act0))
        self.__names['''import TSTL '''] = ('''import TSTL ''',self.guard0,self.act0)
        self.__actionClass['''import TSTL '''] = '''import TSTL '''
        self.__orderings['''import TSTL '''] = 1
        self.__okExcepts['''import TSTL '''] = ''''''
        
        self.__actions.append(('''class CalculatorHarness(TSTL.TestHarness): ''',self.guard1,self.act1))
        self.__names['''class CalculatorHarness(TSTL.TestHarness): '''] = ('''class CalculatorHarness(TSTL.TestHarness): ''',self.guard1,self.act1)
        self.__actionClass['''class CalculatorHarness(TSTL.TestHarness): '''] = '''class CalculatorHarness(TSTL.TestHarness): '''
        self.__orderings['''class CalculatorHarness(TSTL.TestHarness): '''] = 2
        self.__okExcepts['''class CalculatorHarness(TSTL.TestHarness): '''] = ''''''
        
        self.__actions.append(('''def __init__(self): ''',self.guard2,self.act2))
        self.__names['''def __init__(self): '''] = ('''def __init__(self): ''',self.guard2,self.act2)
        self.__actionClass['''def __init__(self): '''] = '''    def __init__(self): '''
        self.__orderings['''def __init__(self): '''] = 3
        self.__okExcepts['''def __init__(self): '''] = ''''''
        
        self.__actions.append(('''super().__init__() ''',self.guard3,self.act3))
        self.__names['''super().__init__() '''] = ('''super().__init__() ''',self.guard3,self.act3)
        self.__actionClass['''super().__init__() '''] = '''        super().__init__() '''
        self.__orderings['''super().__init__() '''] = 4
        self.__okExcepts['''super().__init__() '''] = ''''''
        
        self.__actions.append(('''def setup(self): ''',self.guard4,self.act4))
        self.__names['''def setup(self): '''] = ('''def setup(self): ''',self.guard4,self.act4)
        self.__actionClass['''def setup(self): '''] = '''    def setup(self): '''
        self.__orderings['''def setup(self): '''] = 5
        self.__okExcepts['''def setup(self): '''] = ''''''
        
        self.__actions.append(('''from calculator_module import Calculator ''',self.guard5,self.act5))
        self.__names['''from calculator_module import Calculator '''] = ('''from calculator_module import Calculator ''',self.guard5,self.act5)
        self.__actionClass['''from calculator_module import Calculator '''] = '''        from calculator_module import Calculator '''
        self.__orderings['''from calculator_module import Calculator '''] = 6
        self.__okExcepts['''from calculator_module import Calculator '''] = ''''''
        
        self.__actions.append(('''self.calculator = Calculator() ''',self.guard6,self.act6))
        self.__names['''self.calculator = Calculator() '''] = ('''self.calculator = Calculator() ''',self.guard6,self.act6)
        self.__actionClass['''self.calculator = Calculator() '''] = '''        self.calculator = Calculator() '''
        self.__orderings['''self.calculator = Calculator() '''] = 7
        self.__okExcepts['''self.calculator = Calculator() '''] = ''''''
        
        self.__actions.append(('''def teardown(self): ''',self.guard7,self.act7))
        self.__names['''def teardown(self): '''] = ('''def teardown(self): ''',self.guard7,self.act7)
        self.__actionClass['''def teardown(self): '''] = '''    def teardown(self): '''
        self.__orderings['''def teardown(self): '''] = 8
        self.__okExcepts['''def teardown(self): '''] = ''''''
        
        self.__actions.append(('''pass ''',self.guard8,self.act8))
        self.__names['''pass '''] = ('''pass ''',self.guard8,self.act8)
        self.__actionClass['''pass '''] = '''        pass '''
        self.__orderings['''pass '''] = 9
        self.__okExcepts['''pass '''] = ''''''
        
        self.__actions.append(('''@TSTL.property ''',self.guard9,self.act9))
        self.__names['''@TSTL.property '''] = ('''@TSTL.property ''',self.guard9,self.act9)
        self.__actionClass['''@TSTL.property '''] = '''    @TSTL.property '''
        self.__orderings['''@TSTL.property '''] = 10
        self.__okExcepts['''@TSTL.property '''] = ''''''
        
        self.__actions.append(('''def test_addition(self, x=TSTL.Int(), y=TSTL.Int()): ''',self.guard10,self.act10))
        self.__names['''def test_addition(self, x=TSTL.Int(), y=TSTL.Int()): '''] = ('''def test_addition(self, x=TSTL.Int(), y=TSTL.Int()): ''',self.guard10,self.act10)
        self.__actionClass['''def test_addition(self, x=TSTL.Int(), y=TSTL.Int()): '''] = '''    def test_addition(self, x=TSTL.Int(), y=TSTL.Int()): '''
        self.__orderings['''def test_addition(self, x=TSTL.Int(), y=TSTL.Int()): '''] = 11
        self.__okExcepts['''def test_addition(self, x=TSTL.Int(), y=TSTL.Int()): '''] = ''''''
        
        self.__actions.append(('''result = self.calculator.add(x, y) ''',self.guard11,self.act11))
        self.__names['''result = self.calculator.add(x, y) '''] = ('''result = self.calculator.add(x, y) ''',self.guard11,self.act11)
        self.__actionClass['''result = self.calculator.add(x, y) '''] = '''        result = self.calculator.add(x, y) '''
        self.__orderings['''result = self.calculator.add(x, y) '''] = 12
        self.__okExcepts['''result = self.calculator.add(x, y) '''] = ''''''
        
        self.__actions.append(('''return result == x + y ''',self.guard12,self.act12))
        self.__names['''return result == x + y '''] = ('''return result == x + y ''',self.guard12,self.act12)
        self.__actionClass['''return result == x + y '''] = '''        return result == x + y '''
        self.__orderings['''return result == x + y '''] = 13
        self.__okExcepts['''return result == x + y '''] = ''''''
        
        self.__actions.append(('''@TSTL.property ''',self.guard13,self.act13))
        self.__names['''@TSTL.property '''] = ('''@TSTL.property ''',self.guard13,self.act13)
        self.__actionClass['''@TSTL.property '''] = '''    @TSTL.property '''
        self.__orderings['''@TSTL.property '''] = 14
        self.__okExcepts['''@TSTL.property '''] = ''''''
        
        self.__actions.append(('''def test_subtraction(self, x=TSTL.Int(), y=TSTL.Int()): ''',self.guard14,self.act14))
        self.__names['''def test_subtraction(self, x=TSTL.Int(), y=TSTL.Int()): '''] = ('''def test_subtraction(self, x=TSTL.Int(), y=TSTL.Int()): ''',self.guard14,self.act14)
        self.__actionClass['''def test_subtraction(self, x=TSTL.Int(), y=TSTL.Int()): '''] = '''    def test_subtraction(self, x=TSTL.Int(), y=TSTL.Int()): '''
        self.__orderings['''def test_subtraction(self, x=TSTL.Int(), y=TSTL.Int()): '''] = 15
        self.__okExcepts['''def test_subtraction(self, x=TSTL.Int(), y=TSTL.Int()): '''] = ''''''
        
        self.__actions.append(('''result = self.calculator.subtract(x, y) ''',self.guard15,self.act15))
        self.__names['''result = self.calculator.subtract(x, y) '''] = ('''result = self.calculator.subtract(x, y) ''',self.guard15,self.act15)
        self.__actionClass['''result = self.calculator.subtract(x, y) '''] = '''        result = self.calculator.subtract(x, y) '''
        self.__orderings['''result = self.calculator.subtract(x, y) '''] = 16
        self.__okExcepts['''result = self.calculator.subtract(x, y) '''] = ''''''
        
        self.__actions.append(('''return result == x - y ''',self.guard16,self.act16))
        self.__names['''return result == x - y '''] = ('''return result == x - y ''',self.guard16,self.act16)
        self.__actionClass['''return result == x - y '''] = '''        return result == x - y '''
        self.__orderings['''return result == x - y '''] = 17
        self.__okExcepts['''return result == x - y '''] = ''''''
        
        self.__actions.append(('''if __name__ == "__main__": ''',self.guard17,self.act17))
        self.__names['''if __name__ == "__main__": '''] = ('''if __name__ == "__main__": ''',self.guard17,self.act17)
        self.__actionClass['''if __name__ == "__main__": '''] = '''if __name__ == "__main__": '''
        self.__orderings['''if __name__ == "__main__": '''] = 18
        self.__okExcepts['''if __name__ == "__main__": '''] = ''''''
        
        self.__actions.append(('''CalculatorHarness().run() ''',self.guard18,self.act18))
        self.__names['''CalculatorHarness().run() '''] = ('''CalculatorHarness().run() ''',self.guard18,self.act18)
        self.__actionClass['''CalculatorHarness().run() '''] = '''    CalculatorHarness().run() '''
        self.__orderings['''CalculatorHarness().run() '''] = 19
        self.__okExcepts['''CalculatorHarness().run() '''] = ''''''
